  ...
  return (
    <div className="relative w-full h-screen min-h-screen flex items-center justify-center lg:justify-end overflow-hidden bg-[#0a0f0d]">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-center lg:justify-end mt-20 md:mt-0">
        ...
        {/* Changed max-w-2xl to max-w-lg to prevent overlapping with the hands/plant on the left side */}
        <div className="max-w-lg p-8 md:p-10 rounded-3xl bg-white/10 backdrop-blur-md border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] flex flex-col items-center text-center lg:items-start lg:text-left transition-all duration-500 hover:bg-white-[0.15] lg:mr-4">
          ...
          {/* Primary Headline - Updated to Light Vibrant Green (#1AFF00) */}
          ...
          {/* Secondary Description - Adjusted line-height and sizing for narrower box */}
          ...
          {/* Call to Action Container - Stacked cleanly for the new box size */}
          <div className="flex flex-col sm:flex-row gap-4 w-full">
            
            {/* Primary CTA - Updated to #1AFF00 with dark text for ultimate premium contrast */}
            <button className="relative overflow-hidden group px-6 py-4 bg-[#1AFF00] text-gray-900 text-base sm:text-lg font-extrabold rounded-xl shadow-[0_0_20px_rgba(26,255,0,0.3)] transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(26,255,0,0.5)] w-full sm:w-auto text-center">
              <span className="relative z-10">प्रॉफिट कैलकुलेटर</span>
              <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-in-out"></div>
            </button>
            
            {/* Secondary CTA - Frosted Glass Button styled with #1AFF00 icon */}
            <button className="px-6 py-4 bg-white/5 border border-white/30 backdrop-blur-md hover:bg-white hover:text-black text-white text-base sm:text-lg font-bold rounded-xl shadow-lg transition-all duration-300 hover:scale-[1.02] flex items-center justify-center gap-2 group w-full sm:w-auto">
