...
const ProfitCalculator = () => {
  ...
  return (
    // Base wrapper with a premium smooth gradient canvas
    <section id="calculator" className="w-full bg-gradient-to-b from-gray-50 via-white to-[#e8f5ec] pt-16 pb-44 relative overflow-hidden m-0 border-none">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-5xl font-black text-gray-900 tracking-tight">
            Interactive <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00a63e] to-[#4ade80]">Profit Workspace</span>
          </h2>
        </div>
        ...
        <div className="w-full space-y-10">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-12 gap-6 bg-white/75 backdrop-blur-xl border border-gray-200/60 rounded-2xl p-6 md:p-8 shadow-[0_8px_32px_rgba(0,0,0,0.02)] items-center">
            ...
            <div className="md:col-span-4 space-y-2">
              <label className="flex items-center gap-2 text-xs font-bold text-gray-400 uppercase tracking-widest">
                <Leaf className="w-3.5 h-3.5 text-[#00a63e]" /> 01. Cultivation Specie
              </label>
              <select 
                value={plantKey}
            ...
            <div className="md:col-span-8 space-y-2">
              <div className="flex justify-between items-center">
                <label className="flex items-center gap-2 text-xs font-bold text-gray-400 uppercase tracking-widest">
                  <Target className="w-3.5 h-3.5 text-[#00a63e]" /> 02. Scale Volumetric
                </label>
                <div className="text-sm font-black text-gray-900">
                  <span className="text-xl text-[#00a63e]">{quantity}</span> Plants 
          ...
          {/* UPDATED FOOTNOTE: TEXT SHIFTED TO SOLID HIGH-CONTRAST BLACK */}
