...
const GalleryContent = () => {
  ...
  return (
    <main className="editorial-page w-full min-h-screen bg-[#0D1713] text-white antialiased overflow-hidden pb-32">
      ...
      <section className="premium-section page-hero relative w-full pt-12 pb-10 px-4 sm:px-6 lg:px-8 z-10 max-w-7xl mx-auto mt-6 text-center">
      ...
      <section className="premium-section w-full pb-8 px-4 sm:px-6 lg:px-8 z-20 relative max-w-3xl mx-auto">
      ...
      <section className="premium-section w-full px-4 sm:px-6 lg:px-8 z-10 relative max-w-7xl mx-auto">
