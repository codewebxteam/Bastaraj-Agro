...
const Footer = () => {
  ...
  return (
    <footer className="site-footer w-full bg-[#07100c] text-white py-16 mt-auto relative border-t border-white/10 overflow-hidden">
      
      {/* Subtle Premium Glow Line at the top center - Updated to Primary Green #41A61D */}
      <div className="footer-beam absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-px bg-linear-to-r from-transparent via-[#80ff48]/70 to-transparent"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <div className="flex items-center gap-2.5 text-[#8EA39A] text-sm font-medium">
              ...
              <div className="flex flex-wrap gap-x-2 gap-y-1">
                ...
                <a href="tel:+917999618106" className="hover:text-white transition-colors font-bold">+91 7999618106</a>
              </div>
            </div>

            <div className="flex items-center gap-2.5 text-[#8EA39A] text-sm font-medium">
              <FiMail className="text-[#41A61D] shrink-0 text-base" />
              <a href="mailto:swarnimagf555@gmail.com" className="hover:text-white transition-colors font-bold">swarnimagf555@gmail.com</a>
            </div>
        ...
        <div className="border-t border-[#2C4538] mt-14 pt-8 text-center flex flex-col md:flex-row justify-between items-center select-none">
          <p className="text-[#8EA39A] text-sm mb-4 md:mb-0 tracking-wide font-medium">
            &copy; {new Date().getFullYear()} Swarnim Agro PRIVATE LTD. All rights reserved. | CIN No.: U46200CT2026PTC020693
          </p>
